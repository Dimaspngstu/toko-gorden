...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 30 Jun 2022 pada 08.16
...
--
INSERT INTO
  `detailorder` (`detailid`, `orderid`, `idproduk`, `qty`)
VALUES
  (46, '16Z6c6CpkUmAc', 6, 3);
...
--
INSERT INTO
  `kategori` (`idkategori`, `namakategori`, `tgldibuat`)
VALUES
  (4, 'Gorden Minimalis', '2022-06-29 17:57:57'),
  (5, 'Gorden ruang tamu', '2022-06-29 18:08:42');
...
VALUES
  (
    ...
    'Admin',
    'admin',
    '$2y$10$GJVGd4ji3QE8ikTBzNyA0uLQhiGd6MirZeSJV1O6nUpjSVp1eaKzS',
    '01234567890',
    'Indonesia',
    '2020-03-16 11:31:17',
    'Admin',
  ...
  (
    ...
    'Guest',
    'guest',
    '$2y$10$xXEMgj5pMT9EE0QAx3QW8uEn155Je.FHH5SuIATxVheOt0Z4rhK6K',
    '01234567890',
    'Indonesia',
    '2020-03-16 11:30:40',
    'Member',
  ...
  (
    ...
    'jamil',
    'asiap@gmail.com',
    '$2y$10$XB9M3wtOXWqjFL8YE23JH.uo7bbNBRx4eQEkuzVYm5l60upVEfBG2',
    '089765241',
    'funjual',
    '2022-06-27 17:51:28',
    'Member',
  ...
  (
    ...
    '69tapi',
    'asiapa@gmail.com',
    '$2y$10$SLTSW3DbXRBwUbXXxmDGSO4dc4OiTkvsCh/P8nRVmkfNgyTIKHgCu',
    '08965213333',
    'Tupai',
    '2022-06-28 11:37:05',
    'Member',
...
--
INSERT INTO
  `pembayaran` (`no`, `metode`, `norek`, `logo`, `an`)
VALUES
  (
    1,
    'Bank BCA',
...
VALUES
  (
    6,
    4,
    'Gorden motif piramid',
    'produk/16Skh8zdtB3gg.jpg',
    'Bahan Lembut ',
    4,
    70000,
    50000,
  ...
  (
    8,
    5,
    'Gorden Brown elegant',
    'produk/162e66L5gx8HY.jpg',
    'Membuat ruang tamu anda menjadi mewah',
    5,
    150000,
    100000,
    '2022-06-29 18:10:24'
