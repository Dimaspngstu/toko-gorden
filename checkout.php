...
<body>
	...
	<div class="checkout">
		<div class="container">
			<h1>Terima kasih, <?= $_SESSION['name'] ?> telah membeli <?php echo $itungtrans3 ?> barang di RAPI PESONA DEKOR</span></h1>
		...
		<center>
			...
			?>
				...
				<img src="<?php echo $p['logo'] ?>" width="150px" height="80px"><br>
