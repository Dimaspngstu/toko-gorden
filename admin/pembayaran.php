                              ...
                              <form action="pembayaran_edit.php" method="post">
                                <div class="modal-body">
                                  ...
                                  <div class="form-group">
                                    ...
                                    <input name="metode" type="text" class="form-control" value="<?= $p['metode']; ?>" required autofocus>
                                  </div>
                                  <div class=" form-group">
                                    <label>No. Rekening</label>
                                    <input name="norek" type="text" class="form-control" value="<?= $p['norek']; ?>" required>
                                  </div>
                                  <div class=" form-group">
                                    <label>Atas Nama</label>
                                    <input name="an" type="text" class="form-control" value="<?= $p['an']; ?>" required>
                                  </div>
                                  <div class=" form-group">
                                    <label>URL Logo</label>
                                    <input name="logo" type="text" class="form-control" value="<?= $p['logo']; ?>" required>
                                  </div>
                                </div>
                        ...
                        <div id="modal_hapus<?= $id; ?>" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="my-modal-title" aria-hidden="true">
                          <div class="modal-dialog" role="document">
                            <div class="modal-content">
                              ...
                              <div class="modal-body">
                                <b>Apa Anda yakin ingin menghapus Pembayaran ini?</b>
                              </div>
                              <div class="modal-footer">
                                <form action="pembayaran_hapus.php" method="post">
                                  <input type="hidden" name="no" value="<?= $id; ?>">
